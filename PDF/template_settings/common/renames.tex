...
%%
%%
\newcommand{\keywordsRu}{Легковесная криптография, криптографические алгоритмы, интернет вещей, язык C, сравнительный анализ, сравнительное тестирование} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Lightweight cryptography, cryptographic algorithms, IoT, C language, comparative analysis, benchmarking} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
