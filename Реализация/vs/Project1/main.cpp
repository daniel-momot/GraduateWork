...
{
    unsigned char * wReady = (unsigned char *) malloc(4);
...
unsigned char * keyExpansion(unsigned char key[16])
{
    ...
    unsigned char * expandedKey = (unsigned char *) malloc(176);
...
{
    unsigned char * tempC = (unsigned char *) malloc(16);
...
{
    unsigned char * tempC = (unsigned char *) malloc(18);
...
int main() {
	...
	unsigned char* plain = (unsigned char*) "abcdabcdabcdabcd";
	unsigned char* key = (unsigned char*) "abcdabcdabcdabcd";
	unsigned char* cipher = (unsigned char*) "1234123412341234";
