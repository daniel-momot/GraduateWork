...
static inline void * my_memcpy(void * to, const void * from, size_t n)
{
	...
	__asm__ 
	__volatile__ // отключаем оптимизации, в том числе перестановку команд  https://gcc.gnu.org/onlinedocs/gcc/Extended-Asm.html#Volatile
	( "add %%eax, %%ebx" : "=a" (sum) : "a" (x), "b" (y)	
	);		
